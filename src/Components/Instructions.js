...
const Instructions = () => {
    ...
    return (
        <div>
            ...
            <div style={{ display: "flex", justifyContent: "center"}}>{ready ? <Navigate to="/StatScreen" /> : <button style={{maxWidth:"30vh"}} onClick={() => setReady(true)}>Click Here to Start</button>}</div>
        </div>
    )
}
